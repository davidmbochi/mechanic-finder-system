...
import com.mechanicfinder.mechanicfindersystem.email.EmailSender;
...
public class AdminController {
    ...
    public String approveMechanicApplication(@PathVariable("id") Long id){
        logger.info("mechanic id ============================>"+id);
        Mechanic mechanicById = mechanicService.findMechanicById(id);
        mechanicById.setApplicationStatus(ApplicationStatus.MEMBER);
        Mechanic mechanic = mechanicService.approveMechanic(mechanicById);
        String link = "http://localhost:8080/api/mechanic/add-mechanic-info/"+mechanic.getId();
        emailSender.send(mechanic.getEmail(),buildEmail(
                mechanic.getFirstName(),link
        ));
    ...
    private String buildEmail(String name, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "                      <span style=\"font-family:Helvetica,Arial,sans-serif;font-weight:700;color:#ffffff;text-decoration:none;vertical-align:top;display:inline-block\">Application approved</span>\n" +
                "                    </td>\n" +
                "                  </tr>\n" +
                "                </tbody></table>\n" +
                "              </a>\n" +
                ...
                "        \n" +
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + name + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> Thank you for applying. Your application was successful. Click the link below to update your user information: </p><blockquote style=\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> <a href=\"" + link + "\">Join MechanicFinder</a> </p></blockquote><p>See you soon</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
